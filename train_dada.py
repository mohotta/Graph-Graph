...
def test_model(epoch, model, test_dataloader):
    ...
    if avg_prec > best_ap:
        ...
        torch.save(model.state_dict(), f"model_checkpoints/dada/{model.__class__.__name__}_{epoch}.pth")
        print(f"Saved the model checkpoint - model_checkpoints/dada/{model.__class__.__name__}_{epoch}.pth")
