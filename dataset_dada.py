...
class Dataset(Dataset):
    ...
    def _extract_feature_paths(self, dataset_path, split_path="splits_dada/", training=True):
...
class CrossValDatasetWithNewDistance(Dataset):
    def __init__(self, dataset_path, img_dataset_path, toas_files_path, split_path, ref_interval, objmap_file, training):
...
class FeaturesDatasetWithNewDistance(Dataset):
    def __init__(self, dataset_path, img_dataset_path, toas_files_path, split_path, ref_interval, objmap_file, training):
